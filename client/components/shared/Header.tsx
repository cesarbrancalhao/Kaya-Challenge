...
const Header = () => {
    ...
    return (
        <div className="flex justify-center w-full">
            <header className="bg-[#232323] text-white py-4 px-4 md:px-8 flex flex-wrap items-center justify-between rounded-xl md:rounded-3xl mx-2 md:mx-8 my-4 md:my-8 max-w-7xl w-full">
